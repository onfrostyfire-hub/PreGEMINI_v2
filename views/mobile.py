...
def show():
    st.markdown("""
        ...
        .combo-glow-50 { border-color: #ff00ff !important; box-shadow: 0 0 60px rgba(255, 0, 255, 0.9), 0 4px 15px rgba(0,0,0,0.8) !important; animation: pulse-matrix 0.8s infinite alternate; }
    ...
    THEMES = {
        0: {
            "icon": "⚪", "name": "Sandbox",
            "css": """<style>
            .mobile-game-area { background: radial-gradient(ellipse 50% 38% at 50% 44%, rgba(50,55,60,0.5) 0%, transparent 68%), radial-gradient(ellipse 90% 80% at 50% 50%, #202428 0%, #15181a 55%, #0a0b0d 100%) !important; box-shadow: 0 0 0 8px #0e1012, 0 0 0 13px #16181b, 0 0 0 17px #0b0d0f, 0 0 40px 6px rgba(0,0,0,0.9), inset 0 2px 16px rgba(255,255,255,0.02) !important; }
            ...
            .seat::before { background: radial-gradient(circle at 38% 30%, #1f2226 0%, #111316 60%, #08090a 100%) !important; border: 1.5px solid rgba(140,150,160,0.18) !important; box-shadow: 0 0 0 3px rgba(0,0,0,0.6), inset 0 1px 2px rgba(255,255,255,0.04) !important; }
            .seat::after { background: rgba(255,255,255,0.06) !important; box-shadow: 0 8px 0 rgba(255,255,255,0.04) !important; }
            .seat-active::before { border-color: rgba(160,170,180,0.55) !important; box-shadow: 0 0 0 3px rgba(0,0,0,0.6), 0 0 10px rgba(160,170,180,0.28) !important; animation: r0-pulse 3s ease-in-out infinite !important; }
            @keyframes r0-pulse { 0%,100% { box-shadow: 0 0 0 3px rgba(0,0,0,0.6), 0 0 7px rgba(160,170,180,0.22); } 50% { box-shadow: 0 0 0 3px rgba(0,0,0,0.6), 0 0 16px rgba(160,170,180,0.42); } }
            .seat-label { color: rgba(150,160,170,0.45) !important; text-shadow: 0 1px 3px rgba(0,0,0,0.95) !important; }
            .mob-info-spot { color: rgba(150,160,170,0.4) !important; text-shadow: 0 1px 4px rgba(0,0,0,0.95) !important; }
            .mastery-badge { background: rgba(150,160,170,0.07) !important; border: 1px solid rgba(150,160,170,0.18) !important; color: rgba(180,190,200,0.8) !important; }
...
"""
    ...
    if table_size == 2:
        # HEADS UP РЕЖИМ (ОТОБРАЖАЕМ ТОЛЬКО ОППОНЕНТА НАВЕРХУ)
