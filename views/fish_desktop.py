...
def show():
    ...
    mastery_html = f"""<div style="position: absolute; bottom: -60px; left: 15px; z-index: 15; width: 120px; display: flex; flex-direction: column; align-items: flex-start; gap: 4px; pointer-events: none;">
