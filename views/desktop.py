...
def show():
    st.markdown("""
        ...
        .game-area { position: relative; width: 100%; max-width: 860px; height: 380px; margin: 30 auto 50px auto; border-radius: 190px; transition: background 0.5s, box-shadow 0.5s, border-color 0.5s; overflow: visible; }
        ...
        .rng-desktop { position: absolute; right: -45px; bottom: 15px; width: 34px; height: 34px; border-radius: 50%; font-weight: bold; font-size: 14px; display: flex; align-items: center; justify-content: center; z-index: 40; box-shadow: 0 2px 8px rgba(0,0,0,0.6); }
