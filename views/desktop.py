...
def show():
    st.markdown("""
        ...
        .rng-desktop { position: absolute; right: -45px; bottom: 25px; width: 34px; height: 34px; border-radius: 50%; font-weight: bold; font-size: 14px; display: flex; align-items: center; justify-content: center; z-index: 40; box-shadow: 0 2px 8px rgba(0,0,0,0.6); }
